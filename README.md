...
[![Published](https://img.shields.io/github/release-date-pre/Spellhold-Studios/Infinity-Sounds?display_date=published_at&label=published&color=%2392403a)](https://github.com/Spellhold-Studios/Infinity-Sounds/releases/latest)
...
14. Restore Environmental & Positional Audio
15. Enhance Positional Audio
16. Restore & Tweak Soundsets
17. More Existence Sounds
18. Tweak Existence Sound Delay
19. Restore NPC Voiceovers
20. Additional NPC Voiceovers (by Salk)
...
- Everyone from [Spellhold Studios](http://www.shsforums.net/), [The Gibberlings Three](https://www.gibberlings3.net/forums), [Pocket Plane Group](https://forums.pocketplane.net/), [The Black Wyrm's Lair](http://forums.blackwyrmlair.net/), and other modding communities for keeping the Infinity Engine running.
